...
Beta Version 1.6.6.2.12.2 (patch):
- Scheduled editor actions are ensured by EditorApplication.delayedCall to be executed (fixed issue with ModPack window)
Beta Version 1.6.6.2.12.1 (patch):
- Fixed gui error popup on creating new asset of the ModPack file
